...
labels_file_path = 'all_with_eac/mfcc_labels_all_with_eac.csv'
...
save_to_h5(train_dataset, 'all_with_eac/train_dataset_eac_with_all.h5')
save_to_h5(val_dataset, 'all_with_eac/val_dataset_eac_with_all.h5')
save_to_h5(test_dataset, 'all_with_eac/test_dataset_eac_with_all.h5')
...
train_label_counts = count_labels_in_h5('all_with_eac/train_dataset_eac_with_all.h5')
val_label_counts = count_labels_in_h5('all_with_eac/val_dataset_eac_with_all.h5')
test_label_counts = count_labels_in_h5('all_with_eac/test_dataset_eac_with_all.h5')
